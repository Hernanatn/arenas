...
`Arena` es una librería ligera en C++ diseñada para la asignación eficiente de memoria paginada en contextos de uso intensivo, donde los patrones de asignación y liberación son predecibles. Utiliza el modelo de **"Asignar una vez, liberar una vez"**, simplificando el manejo de memoria y reduciendo el overhead asociado con múltiples llamadas a `malloc` y `free`.

![Hecho por Chaska](https://img.shields.io/badge/hecho_por-Ch'aska-303030.svg)
![Versión: Beta v1.0.0](https://img.shields.io/badge/version-Beta_v1.0.0-orange.svg)
![Verisón de C++: 17+](https://img.shields.io/badge/C++-17%2B-blue?logo=cplusplus)
[![Licencia: CC BY-SA 4.0](https://img.shields.io/badge/Licencia-CC_BY--SA_4.0-lightgrey.svg)](LICENSE)
